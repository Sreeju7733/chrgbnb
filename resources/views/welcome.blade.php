...
<head>
    ...
    <title>VoltCharge | The Airbnb for EV Charging</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="fas fa-bolt me-2"></i>VoltCharge
            </a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <p class="hero-subtitle">The world's first decentralized EV charging network. Find private chargers in neighborhoods or monetize your home station.</p>
    ...
    <section id="how-it-works" class="py-100 mt-5">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="text-muted">Getting your car charged shouldn't be a hassle.</p>
            </div>
    ...
    <!-- Host CTA -->
    <section id="host" class="container">
        <div class="cta-section">
            <div class="container px-5">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <h2 class="display-4 fw-bold mb-4">Turn your parking spot into a revenue stream.</h2>
                        <p class="lead opacity-75 mb-5">Have a home charger or a dedicated parking space? List it on VoltCharge and start earning while you sleep.</p>
    ...
    <footer>
        <div class="container">
            <div class="row g-4 mb-5">
                <div class="col-lg-4">
                    <div class="navbar-brand mb-3 d-block"><i class="fas fa-bolt me-2"></i>VoltCharge</div>
                ...
                <div class="col-6 col-lg-2 ms-lg-auto">
                    ...
                    <ul class="list-unstyled text-muted">
                        ...
                        <li class="mb-2"><a href="#" class="text-decoration-none text-muted">Safety</a></li>
                    </ul>
                </div>
            ...
            <div class="text-center text-muted small pt-4">
                © 2026 VoltCharge Technologies Inc. All rights reserved.
            </div>
        </div>
    </footer>
