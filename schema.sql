...
CREATE TABLE `bookings` (
  ...
  KEY `bookings_charger_id_status_index` (`charger_id`,`status`),
  KEY `bookings_start_time_end_time_index` (`start_time`,`end_time`),
  CONSTRAINT `bookings_charger_id_foreign` FOREIGN KEY (`charger_id`) REFERENCES `chargers` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `chargers` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `chargers_host_id_foreign` (`host_id`),
  KEY `chargers_latitude_longitude_index` (`latitude`,`longitude`),
  KEY `chargers_status_host_id_index` (`status`,`host_id`),
  CONSTRAINT `chargers_host_id_foreign` FOREIGN KEY (`host_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
CREATE TABLE `vehicles` (
  ...
  `current_soc_percent` int(11) NOT NULL DEFAULT 100,
...
-- Dump completed on 2026-05-05 16:56:27
